...
model = pickle.load(open('C:\\Users\\tanej_23j9ili\\OneDrive\\Documents\\rain prediction project\\Rain-Prediction\\modelsaved', "rb"))
print("Model Loaded")
...
def predict():
	...
	if request.method == "POST":
		...
		day = int(pd.to_datetime(date, format="%d-%m-%Y").day)
		month = int(pd.to_datetime(date, format="%d-%m-%Y").month)
		# MinTemp
